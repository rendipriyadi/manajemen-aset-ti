...
class DeviceMore extends Model
{
    ...
    public function device_pc()
    {
        ...
        return $this->hasMany('App\Models\Data\Hardware\DeviceUser', 'device_more_id');
    }

    public function troubleshoot_device_more()
    {
        return $this->hasMany(TroubleshootDeviceMore::class, 'device_more_id');
    }
}
