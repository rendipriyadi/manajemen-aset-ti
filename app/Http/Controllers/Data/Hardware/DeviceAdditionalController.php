...
class DeviceAdditionalController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('pages.data.hardware.device-additional.show', compact('device_additional'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.data.hardware.device-additional.edit', compact('device_additional', 'accessories'));
    }
