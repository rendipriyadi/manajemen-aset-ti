        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">IP Address</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.ip_address.store') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="start_ip" name="start_ip"
                                                            ...
                                                            value="{{ old('start_ip') }}" autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="end_ip" name="end_ip"
                                                            class="form-control" placeholder="example 200.200.200.200"
                                                            value="{{ old('end_ip') }}" autocomplete="off" required>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">List Ip Adress</h4>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Ip Address Awal</th>
                                                        <th class="text-center">Ip Address Akhir</th>
                                                        <th class="text-center">Keterangan</th>
                                                        <th style="text-align:center; width:150px;">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @forelse($ip_address as $key => $ip_address_item)
                                                        <tr data-entry-id="{{ $ip_address_item->id }}">
                                                            <td class="text-center">{{ $loop->iteration }}</td>
                                                            <td class="text-center">
                                                                {{ $ip_address_item->division->name ?? '' }}</td>
                                                            <td class="text-center">{{ $ip_address_item->start_ip ?? '' }}
                                                            </td>
                                                            <td class="text-center">{{ $ip_address_item->end_ip ?? '' }}
                                                            </td>
                                                            <td class="text-center">
                                                                {{ $ip_address_item->description ?? '' }}
                                                            </td>
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('backsite.ip_address.edit', encrypt($ip_address_item->id)) }}">
                                                                            Edit
                                                                        </a>
                                                                        <form
                                                                            action="{{ route('backsite.ip_address.destroy', encrypt($ip_address_item->id)) }}"
                                                                            method="POST"
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Divisi</th>
                                                        <th>Ip Address Awal</th>
                                                        <th>Ip Address Akhir</th>
                                                        <th>Keterangan</th>
                                                        <th>Action</th>
                                                    </tr>
                                                </tfoot>
