        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Jenis Pekerjaan</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.work_type.store') }}"
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">List Jenis Pekerjaan</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    @forelse($work_type as $key => $work_type_item)
                                                        <tr data-entry-id="{{ $work_type_item->id }}">
                                                            <td class="text-center">{{ $loop->iteration }}</td>
                                                            <td class="text-center">
                                                                @if ($work_type_item->section == 3)
                                                                    <span
                                                                        class="badge badge-danger">{{ 'Administrasi' }}</span>
                                                                @elseif($work_type_item->section == 4)
                                                                    <span
                                                                        class="badge badge-warning">{{ 'Hardware & Jaringan' }}</span>
                                                                @elseif($work_type_item->section == 5)
                                                                    <span
                                                                        class="badge badge-secondary">{{ 'Peralatan Tol' }}</span>
                                                                @elseif($work_type_item->section == 6)
                                                                    <span
                                                            ...
                                                            <td class="text-center">{{ $work_type_item->name ?? '' }}
                                                            </td>
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('backsite.work_type.edit', encrypt($work_type_item->id)) }}">
                                                                            Edit
                                                                        </a>
                                                                        <form
                                                                            action="{{ route('backsite.work_type.destroy', encrypt($work_type_item->id)) }}"
                                                                            method="POST"
