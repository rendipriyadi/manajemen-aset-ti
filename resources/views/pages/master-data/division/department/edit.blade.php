        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Departemen</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.department.update', [$department->id]) }}"
                                                        ...
                                                        <select name="division_id" id="division_id"
                                                            ...
                                                            @foreach ($division as $key => $division_item)
                                                                <option value="{{ $division_item->id }}"
                                                                    {{ $division_item->id == $department->division_id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            ...
                                                            value="{{ old('name', isset($department->name) ? $department->name : '') }}"
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.department.index') }}" style="width:120px;"
