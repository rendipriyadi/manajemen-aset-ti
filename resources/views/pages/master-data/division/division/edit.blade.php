        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Divisi</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.division.update', [$division->id]) }}" method="POST"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="kode" name="kode"
                                                            ...
                                                            value="{{ old('kode', isset($division->kode) ? $division->kode : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="name" name="name"
                                                            class="form-control" placeholder="example John Doe or Jane"
                                                            value="{{ old('name', isset($division->name) ? $division->name : '') }}"
                                                            autocomplete="off" required>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.division.index') }}" style="width:120px;"
