                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.hardisk.store') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" id="name" name="name"
                                                            class="form-control" placeholder="isi nama hardisk disini"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" id="size" name="size"
                                                            class="form-control" placeholder="isi ukuran/kapasitas hardisk"
                                                            ...
                                                            <td class="text-center">
                                                                <div class="mb-1 mr-1 btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('backsite.hardisk.destroy', encrypt($hardisk_item->id)) }}"
                                                                            method="POST"
