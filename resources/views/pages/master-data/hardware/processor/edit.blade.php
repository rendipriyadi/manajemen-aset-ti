                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.processor.update', [$processor->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <textarea rows="3" class="form-control" id="description" name="description">{{ isset($processor->description) ? $processor->description : '' }}</textarea>
                                                    </div>
                                                </div>
