                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.motherboard.update', [$motherboard->id]) }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <textarea rows="3" class="form-control" id="description" name="description">{{ isset($motherboard->description) ? $motherboard->description : '' }}</textarea>
                                                    </div>
                                                </div>
