                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse hide">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form class="form form-horizontal" action="{{ route('backsite.location.store') }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="name">Lokasi <code
                                                ...
                                                <tbody>
                                                    @forelse($location as $key => $location_item)
                                                        <tr data-entry-id="{{ $location_item->id }}">
                                                            ...
                                                            <td class="text-center">{{ $location_item->name ?? '' }}</td>
                                                            <td class="text-center">
                                                                <div class="btn-group mr-1 mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('backsite.location.destroy', encrypt($location_item->id)) }}"
                                                                            method="POST"
