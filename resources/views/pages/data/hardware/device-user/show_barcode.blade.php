        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="mb-2 content-header-left col-md-6 col-12 breadcrumb-new">
                    <h3 class="mb-0 content-header-title d-inline-block">Data Device User</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        <tr>
                                            <th>User</th>
                                            <td>{{ $device_user->employee->nip ?? 'N/A' }} -
                                                {{ $device_user->employee->name ?? 'N/A' }} -
                                            ...
                                            <td>
                                                @foreach (explode(',', $device_user->device_additional_id) as $data_additional)
                                                    ...
                                                    @foreach ($spek_additional as $additional)
                                                        ...
                                                        - {{ $additional->name_type_device ?? 'N/A ?>' }} -
                                                        {{ $additional->name ?? 'N/A ?>' }} ||
                                                    @endforeach
                                                @endforeach
                                            </td>
                                        ...
                                        <tr>
                                            <th>Lokasi</th>
                                            <td>
                                                {{ $device_user->location_detail->location_room->name ?? 'N/A' }} -
                                                {{ $device_user->location_detail->location_sub->name ?? 'N/A' }} -
                                                {{ $device_user->location_detail->location->name ?? 'N/A' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>File</th>
                                            <td> <a data-fancybox="gallery"
                                                    data-src="{{ asset('storage/' . $device_user->file) }}"
