                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="name" name="name" class="form-control"
                                                placeholder="isi nama pc" value="{{ old('name') }}" autocomplete="off"
                                                required>
...
<form class="form" action="{{ route('backsite.device_pc.export-pdf') }}" method="POST">
                                    ...
                                    <tbody>
                                        @forelse($device_pc as $key => $device_pc_item)
                                            <tr data-entry-id="{{ $device_pc_item->id }}">
                                                ...
                                                <td class="text-center">{{ $device_pc_item->motherboard->name }}</td>
                                                <td class="text-center">{{ $device_pc_item->processor->name }}</td>
                                                    ...
                                                    <div class="mb-1 mr-1 btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="#mymodal"
                                                                ...
                                                                data-title="Detail Device PC" class="dropdown-item">
                                                                Show
                                                            </a>
