                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="name" name="name"
                                                            class="form-control"
                                                            value="{{ old('name', isset($device_monitor->name) ? $device_monitor->name : '') }}"
                                                            autocomplete="off" required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="size" name="size"
                                                            class="form-control"
                                                            value="{{ old('size', isset($device_monitor->size) ? $device_monitor->size : '') }}"
                                                            autocomplete="off" required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="status" id="status" class="form-control select2">
                                                            <option value="1"
                                                                {{ $device_monitor->status == 1 ? 'selected' : '' }}>Ready
                                                                to Deploy</option>
                                                            <option value="2"
                                                                {{ $device_monitor->status == 2 ? 'selected' : '' }}>Deploy
                                                            </option>
                                                        </select>
